      ...
      <header className="flex items-center justify-between p-4 bg-secondary text-on-secondary border-b border-border">
        <div className="flex items-center space-x-3">
          <button
            ...
            className="p-2 hover:bg-secondary-variant rounded-full transition-colors touch-manipulation"
            title="Back to chats"
          >
          ...
          <div className="text-center">
            <div className="relative inline-block mb-6">
              {avatarUrl ? (
                ...
                <div className="w-24 h-24 sm:w-32 sm:h-32 bg-secondary rounded-full flex items-center justify-center text-on-secondary text-2xl sm:text-4xl font-bold border-4 border-primary">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-border rounded-lg shadow-sm bg-surface text-on-surface focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary text-base"
            ...
            <button
              ...
              className="w-full px-4 py-3 bg-primary text-on-primary rounded-lg hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-base font-medium"
            >
